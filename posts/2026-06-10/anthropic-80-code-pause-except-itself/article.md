...
<div class="img-placeholder concept">
  ...
  <details><summary>生成 Prompt</summary><pre>An AI robot arm assembling a smaller copy of itself on a factory line, recursive self-replication loop, minimalist flat design, tech illustration, deep blue and white color palette, no text, no labels, clean white background</pre></details>
</div>
...
【副标题】：Claude 写进 Anthropic 代码库的比例
【单位】：%
【核心判断】：15 个月，从个位数到 80%——它的产品，主要由它的另一个产品制造
【核心内容】：
  - 2025年2月 Claude Code 发布前：3
  - 2026年5月：80</pre></details>
</div>
...
<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>A runner sprinting toward a stock-market IPO bell at full speed while holding up a red pause road sign in the other hand, split-direction tension, minimalist flat editorial illustration, deep blue with red accent on white, no text, no labels, clean white background</pre></details>
</div>
...
<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>A giant red pause button whose cable runs in series through four heavy padlocked iron gates, every padlock firmly shut, implying the pause can never be triggered, minimalist flat editorial illustration, deep blue with red accent on white, no text, no labels, clean white background</pre></details>
</div>
...
【副标题】：AI 写代码的占比，三家都在报
【单位】：%
【核心判断】：同样的事实，只有正在 IPO 的那家把它讲成了"该按暂停键"
【核心内容】：
  - 谷歌（皮查伊2024年10月）：25
  - 微软（纳德拉2025年4月）：30
  - Anthropic（2026年5月）：80</pre></details>
</div>
