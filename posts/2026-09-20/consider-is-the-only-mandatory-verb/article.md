...
![法案要求各州走完的程序链，终点合法地允许"不采纳"。](images/illus_01.png)
...
![软的那部被嫌太软，硬的那部被当场挡下，同一个下午。](images/illus_02.png)
...
![联邦标准门槛 100 兆瓦，宾州 50、弗州 25——而且它们已经生效了。](images/illus_03.png)
...
![正在计费的这个容量年，PJM 全区价格顶到了上限。](images/illus_04.png)
