...
![图注：72 小时三连击——发明地基的人、拿诺奖的人、市场结账，按顺序发生在同一周。](images/illus_01.png)
...
<div class="img-placeholder concept">
  ...
  <details><summary>生成 Prompt</summary><pre>A large tree heavy with golden fruit, but hands reaching in from outside the frame are picking the fruit and carrying it away to two smaller buildings in the distance, flat design, minimalist illustration, tech style, blue and white color palette with warm gold accents, conceptual metaphor of invention being harvested by others, no text, no labels, clean white background</pre></details>
</div>
...
![图注：留不住人的，从来不是出价高低，是「在哪能赢」这个判断——Google 输在这里。](images/illus_02.png)
...
![图注：留存率三家咬得很近，但净流向是单向的——11:1 不是流动，是逃逸。](images/illus_03.png)
