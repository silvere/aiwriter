...
<div class="img-placeholder concept">
  ...
  <details><summary>生成 Prompt</summary><pre>An abstract editorial illustration of a stack of SEC IPO filing documents and legal compliance papers, with a tiny CEO figure standing on top holding a microphone. The papers form a structural foundation. Flat design, minimalist illustration, finance and legal style, dark blue and beige color palette, no text, no labels, clean white background</pre></details>
</div>
...
<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>A tech CEO speaking from a giant video screen at a corporate conference stage, with abstract financial documents and SEC filing papers floating in the foreground. Split-second moment of contradiction. Flat design, minimalist illustration, tech style, blue and white and grey color palette, no text, no labels, clean background</pre></details>
</div>
