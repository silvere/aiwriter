...
<div class="img-placeholder concept">
  ...
  <details><summary>生成 Prompt</summary><pre>an iPhone opened like a hardware bay, a glowing brain-shaped chip module being slotted into a socket, several blank unbranded brain chips waiting on a nearby shelf, flat design, minimalist illustration, tech style, blue and white color palette, no text, no labels, clean white background</pre></details>
</div>
...
<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>a row of identical standardized sockets on a sleek surface, several different unbranded glowing AI brain modules lined up waiting to plug into one slot, one already plugged in, concept of a universal interface protocol, flat design, minimalist illustration, tech style, blue and white color palette, no text, no labels, clean white background</pre></details>
</div>
...
【副标题】：谷歌与苹果之间，钱的两个方向
【单位】：亿美元
【核心判断】：即便当买家，苹果付给供应商的也只有对方付给它的 1/20——分发吃模型
【核心内容】：
  - 谷歌付苹果·买 Safari 默认搜索（2022，法庭作证）[流入]：200
  - 苹果付谷歌·买 Gemini 模型（每年，报道）[流出]：10</pre></details>
</div>
...
<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>a glowing Siri-like orb on an iPhone, behind it a faceless assembly line of identical interchangeable brain modules on a conveyor belt, one module being installed, anonymous mass-produced components, cold industrial minimalism, flat design, blue and white color palette, no text, no labels, clean background</pre></details>
</div>
