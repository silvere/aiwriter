...
【副标题】：佛州诉状里 OpenAI 的"承诺"与"实际"
【核心判断】：承诺 20% 算力做安全，实际 1-2%；该测数月的模型，测了一周
【核心内容】：
  - 承诺投入安全的算力 [流入]：20
  - 实际投入安全的算力 [流出]：2
  - 规定的安全测试时长（月） [参照]：3
  - GPT-4o 实际测试时长（约0.25月） [流出]：1</pre></details>
</div>
...
<div class="img-placeholder concept">
  ...
  <details><summary>生成 Prompt</summary><pre>A blueprint of a complex machine being locked inside a heavy steel safe, a question mark stamped on the safe door, conceptual illustration about restricting access to how something is built, flat design, minimalist illustration, tech style, blue and white color palette, no text, no labels, clean white background</pre></details>
</div>
...
【副标题】：同一周的一记组合拳
【核心判断】：州权从部署端侧门告进去，联邦把开发端正门焊死三年
【核心内容】：
  - 6/1 佛州起诉：走部署端侧门(FDUTPA)，证据指向开发端
  - 6/4 国会法案：preempt 各州"开发"立法权，放过部署
  - 结果：头条案件幸存，治本的开发端立法被冻结三年
  - 真正被保护的：模型怎么造，三年内各州无权过问</pre></details>
</div>
...
【副标题】：把"冻结各州管AI"塞进法律的三次尝试
【单位】：—
【核心判断】：从预算法案到国防授权到专门立法，preemption 第三次卷土重来
【核心内容】：
  - 2025年中 预算和解法案塞暂停令：参议院99-1否决
  - 2025年底 NDAA 夹带 preemption：两党联手删除
  - 2025/12 行政令设AI诉讼工作组：合法性存疑
  - 2026/6 Great American AI Act：第三次，改走专门立法</pre></details>
</div>
...
<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>A tug of war between three different groups pulling a rope in three directions, representing a three-way power struggle, conceptual illustration, flat design, minimalist, tech and politics theme, blue red and gray color palette, no text, no labels, clean white background</pre></details>
</div>
