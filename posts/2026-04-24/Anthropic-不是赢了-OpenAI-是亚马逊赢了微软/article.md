# Anthropic 不是赢了 OpenAI，是亚马逊赢了微软

> **发布日期**：2026-04-24 | **分类**：AI深度报道

## 核心观点

- Anthropic 二级市场 1 万亿美金估值里，至少 1300 亿要原路返回亚马逊、谷歌、微软的算力账本——这不是一家 AI 公司在赚钱，是三家云厂商在互相给对方的账本写数字
- OpenAI 和 Anthropic 的估值对决，台上是两家 AI 实验室，台下其实是微软+英伟达 vs 亚马逊+谷歌的代理人战争
- 二级市场的万亿，和公司传闻中的 IPO 目标价 4000-5000 亿美金，差出的 5000 亿美金不是公司价值，是"谁能拿下下一张算力订单"的入场券溢价

---

## 导语

4 月 23 日，Forge Global 上的 Anthropic 股价报到了 1 万亿美金。同一张交易屏幕上，OpenAI 是 8800 亿。

历史性时刻。全球最大的 AI 独角兽换人了。微信公众号标题齐刷刷往一个方向倒——"Claude Code 太猛了"、"OpenAI 大势已去"、"Dario 兄妹反杀奥特曼"。

朋友圈里面转发这条新闻的人，十有八九带一句"AI 赛道真的卷"。

不卷。这不是两家 AI 公司的事。

你把这场仗的所有合同、所有投资协议、所有算力承诺摆到桌面上对账，会发现一件很尴尬的事实：**这一万亿里面，至少三分之一是亚马逊和谷歌自己掏给自己的。**

Anthropic 没有反超 OpenAI。

反超的是 Anthropic 身后的那两家云厂商。它们联手把微软和英伟达按在了这轮 AI 资本竞赛的桌角，顺便让前台那位叫 Dario Amodei 的科学家，多了几个身家百亿的纸面头衔（笑）。

<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>Two AI company mascots shaking hands on a brightly lit stage while behind the curtain, three giant cloud corporation logos are calculating profits on ledgers, surreal proxy war imagery, flat design, minimalist illustration, tech style, blue and white color palette, no text, no labels, clean white background</pre></details>
</div>
...
这叫什么投资？这叫**预付卡**。亚马逊给 Anthropic 发了一张 330 亿面值的 AWS 预付卡，要求持卡人必须消费 1000 亿。
...
<div class="img-placeholder diagram">
  ...
  <details><summary>规格卡</summary><pre>【图类型】：对比图（横向条形）
【核心内容】：
  - AWS投资Anthropic：330亿
  - Anthropic承诺AWS算力：1000亿
  - Microsoft投资Anthropic：150亿
  - Anthropic承诺Azure算力：300亿
  - Anthropic年化收入(2026年4月)：300亿
【布局建议】：横向条形图，前四项两两成对，形成鲜明倒流箭头；最后一项单独放下方作为参照
【配色】：主色 #1A56DB，强调色 #F05252（流出项），背景 #FFFFFF</pre></details>
</div>
...
【核心内容】：
  - OpenAI阵营-Azure算力：主力
  - OpenAI阵营-NVIDIA芯片：10吉瓦承诺
  - OpenAI阵营-亚马逊份额：0
  - OpenAI阵营-谷歌份额：0
  - Anthropic阵营-AWS Trainium：5吉瓦
  - Anthropic阵营-Google TPU：3.5吉瓦
  - Anthropic阵营-Microsoft份额：次要
【布局建议】：左右分栏对比，每侧列出合作伙伴和承诺容量
...
- [Anthropic reaches $1 trillion valuation on secondary markets - Quartz](https://qz.com/anthropic-trillion-dollar-valuation-secondary-markets-openai-052626)
- [Anthropic Beats OpenAI on Secondary Markets With $1 Trillion Implied Valuation - Decrypt](https://decrypt.co/365384/anthropic-1-trillion-valuation-secondary-markets-openai)
- [Anthropic Hits a Trillion-Dollar Valuation on Secondary Markets - Tom's Hardware](https://www.tomshardware.com/tech-industry/artificial-intelligence/anthropic-surpasses-biggest-rival-openai-in-secondary-market-valuation-surges-to-usd1-trillion-amid-frantic-investor-interest)
- [Anthropic raises $30 billion in Series G funding at $380 billion valuation - Anthropic](https://www.anthropic.com/news/anthropic-raises-30-billion-series-g-funding-380-billion-post-money-valuation)
- [Amazon's $25B Anthropic Deal Is Circular Revenue, Not Investment - Humai](https://www.humai.blog/amazon-just-invested-25b-in-anthropic-anthropic-will-send-100b-right-back/)
- [Anthropic adds compute power with Google, Broadcom deals - Yahoo Finance](https://finance.yahoo.com/sectors/technology/articles/anthropic-adds-compute-power-google-151729696.html)
...
- [Charted: Compute Costs More Than Talent in AI - Visual Capitalist](https://www.visualcapitalist.com/visualized-the-costs-of-ai-companies/)
- [Anthropic 二级市场估值飙升至1万亿美元 - 新浪财经](https://finance.sina.com.cn/tech/digi/2026-04-23/doc-inhvnnxe5491157.shtml)
- [AI Is Not Improving Productivity: Daron Acemoglu - MIT Sloan Management Review](https://sloanreview.mit.edu/audio/ai-is-not-improving-productivity-nobel-laureate-daron-acemoglu/)
