...
![这条红线的市场价是 0——守它的成本全由 Anthropic 一家扛，买方一分不付，因为随时能换个不设线的供应商。](images/illus_01.png)

*这条红线的市场价是 0——守它的成本全由 Anthropic 一家扛，买方一分不付，因为随时能换个不设线的供应商。*
...
![同一天几小时内，Anthropic 那扇门被焊死（被拉黑），隔壁 OpenAI 的门却大开（接单）——红线拦住的是名字，不是武器。](images/illus_02.png)

*同一天几小时内，Anthropic 那扇门被焊死（被拉黑），隔壁 OpenAI 的门却大开（接单）——红线拦住的是名字，不是武器。*
...
![对外定性「国家安全威胁」，私下次日又发邮件说「我们很接近了」——法官判这两句话极难自圆其说。](images/illus_03.png)

*对外定性「国家安全威胁」，私下次日又发邮件说「我们很接近了」——法官判这两句话极难自圆其说。*
