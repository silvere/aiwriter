...
2024 年底，一批全世界最好的数学家接了个私活：给一个数学基准出题，题目要难到能难住最强的 AI。他们不知道出钱的是谁。直到当年 12 月 20 日，一家叫 Epoch AI 的机构披露，金主是 OpenAI，而且 OpenAI 拿到了这批题目里除留存集之外几乎全部的访问权限。而就在同一天，OpenAI 发布了新模型 o3，把它在这个基准上考出的高分，摆成了发布会的亮点。出题的人和考试的人，原来是同一个。

这件事被当成一次公关翻车讨论过去了。但它其实是一个更大变化的缩影——当 AI 越来越会考试，"谁来给它出题"这件事，正在悄悄变成一门生意，一门只有少数几家公司做得起的生意。
...
![一级更比一级难，却一级更比一级快被刷穿：为撑几年造的题，一个产品周期就被吃掉大半](images/illus_01.png)

*一级更比一级难，却一级更比一级快被刷穿：为撑几年造的题，一个产品周期就被吃掉大半*

  <svg viewBox="0 0 1000 400" style="width:100%;height:auto;margin-top:18px">
    <line x1="60" y1="340" x2="960" y2="340" stroke="var(--hair)" stroke-width="2"/>
  ...
  <div class="legend" style="margin-top:8px">
    <div class="lg"><div class="dot" style="background:var(--accent)"></div><div><div class="n">+30<small style="font-size:20px">pp</small></div><div class="t">HLE 一年内被刷分：个位数 → 三四成</div></div></div>
    <div class="lg"><div class="dot" style="background:var(--accent-deep)"></div><div><div class="n">15%→93%</div><div class="t">Cybench：AI agent 解题率一年翻六倍</div></div></div>
  </div>

  <div class="punch">出题的速度，追不上做题的速度：<b>为撑几年造的题，一个产品周期就被吃掉大半</b></div>
</div></pre></details>
</div>
...
![同一把尺子，从广场搬进办公室：能看的人、能挑错的人，都变少了](images/illus_02.png)

*同一把尺子，从广场搬进办公室：能看的人、能挑错的人，都变少了*

  <svg viewBox="0 0 1000 460" width="100%" height="380" xmlns="http://www.w3.org/2000/svg">
    <!-- left: open plaza -->
    <circle cx="230" cy="240" r="175" fill="var(--accent-soft)" stroke="var(--accent)" stroke-width="2.5" stroke-dasharray="7 6"/>
    <text x="230" y="90" text-anchor="middle" font-size="16" font-weight="600" fill="var(--accent-deep)">公开的广场</text>
    <text x="230" y="112" text-anchor="middle" font-size="13" fill="var(--sub)">谁都能看 · 谁都能挑错</text>
  ...
  <div class="punch">代价：题目、答案、评估方法不再公开，<b>独立监督变得几乎不可能</b></div>
</div></pre></details>
</div>
...
![同一方绕了一圈：当出钱、能看答案、参加考试、公布成绩都是同一家，分数就失去了独立性](images/illus_03.png)

*同一方绕了一圈：当出钱、能看答案、参加考试、公布成绩都是同一家，分数就失去了独立性*

  <svg viewBox="0 0 900 460" width="100%" height="380" style="margin-top:8px">
    <defs>
      <marker id="arrow" viewBox="0 0 10 10" refX="8" refY="5" markerWidth="7" markerHeight="7" orient="auto-start-reverse">
  ...
  <div class="punch">出题的数学家事先不知道金主是谁,而<b>出钱、能看答案、参加考试、公布成绩,是同一家</b></div>
</div></pre></details>
</div>
...
- [TechCrunch: AI benchmarking organization criticized for waiting to disclose OpenAI funding（FrontierMath / Epoch AI，2025-01）](https://techcrunch.com/2025/01/19/ai-benchmarking-organization-criticized-for-waiting-to-disclose-openai-funding/)
- [Stanford HAI: AI Index Report 2026（HLE 一年约 +30 个百分点 / Cybench 15%→93%）](https://aiindex.stanford.edu/report/)
- [ACL Anthology 2024: 主流基准数据污染研究（MMLU 29.1% / C-Eval 45.8%）](https://aclanthology.org/2024.findings-emnlp.30/)
- [Scale AI / CAIS: Humanity's Last Exam（50 万美元征题奖池，2024-09-15）](https://agi.safe.ai/)
- [Surge AI 营收与出题专家市场报道（约 10 亿美元营收 / 专家规模两万→近五万，2024–2025 综合媒体报道）](https://www.surgehq.ai/)
- [arXiv: When AI Benchmarks Plateau（私有测试集无抗饱和保护效应）](https://arxiv.org/abs/2602.16763)
- [Narayanan & Kapoor: AI Agents That Matter（评估方法论四类缺陷）](https://arxiv.org/abs/2407.01502)
- [European Commission: General-Purpose AI Code of Practice（EU AI Act 第 15(2) 条 / 10^25 FLOPs / GPAI 提供方罚则上限 1500 万欧元或 3% 营业额）](https://digital-strategy.ec.europa.eu/en/policies/ai-code-practice)
- [NIST AI Risk Management: 基准饱和列为风险类别](https://www.nist.gov/itl/ai-risk-management-framework)
