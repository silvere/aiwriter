# 教皇骂 AI 是「统治、排斥与死亡的工具」那天，Anthropic 创始人就站在他旁边（笑）

> **发布日期**：2026-05-26 | **分类**：AI产业深度

## 导语

2026 年 5 月 25 日上午 11 点 30 分，梵蒂冈圣议会大厅。Leo XIV 教皇站在台前念第一份通谕——83 页，题目叫《Magnifica Humanitas》，副标题是「论在人工智能时代守护人之尊严」。这一份通谕签字日期是 5 月 15 日，整整 135 年前的同一天，他的同名前任 Leo XIII 发布过《Rerum Novarum》——那一份给工业革命定了天主教社会教义的基本格律。
...
人工智能现在要求被解除武装，要求脱离那些让它变成统治、排斥与死亡之工具的逻辑。台下镜头拉过来，前排第四个嘉宾，挂牌写着「Christopher Olah, Co-Founder of Anthropic」。轮到他上台致辞，第一句他承认：「Every frontier AI lab operates inside a set of incentives and constraints that can sometimes conflict with doing the right thing.」——每一家前沿 AI 实验室，都活在一套有时会与做正确的事相冲突的激励和约束里。

念完通谕的同一周——精确说是同一个工作周——Anthropic 自己这家「前沿 AI 实验室」，在硅谷和华尔街那一侧做完了下面这五件事：

一、关掉 300 亿美金的融资，900 亿美金（约 6500 亿人民币）pre-money 估值，超过 OpenAI 成为全球最值钱的 AI 创业公司；二、Q2 季度收入预计 109 亿美金，annualized run rate 6 月底破 500 亿，首次实现单季度运营盈利 5.59 亿美金；三、给马斯克的 xAI 每月交 12.5 亿美金 GPU 房租，合同到 2029 年 5 月，总金额 450 亿美金，相当于把 SpaceX 一年营收的 25% 直接打过去；四、和五角大楼仍在加州联邦法院打官司——后者从 3 月 1 日开始用 25 个「power user」在 GenAI.mil 平台上测试 OpenAI、Google、xAI 的 Grok，目的是把 Claude 替换掉；五、被 Ed Zitron 在自家博客上拆穿那 5.59 亿利润是「一次性 SpaceX 折扣的非 GAAP 数字」。

圣议会大厅那一边收圣油，加州那一边告联邦政府，五角大楼那一边在做替换测试，SpaceX 那一边收房租。这一切发生在同一周。

外面看是五条新闻。里面看是同一家公司这一周的五个动作。
...
900 亿美金估值这一周完成的事，是**让"塑造 AI 的少数权贵"再少了若干人**——一轮融资把估值再翻一倍，意味着 Anthropic 团队的股权浓度（团队持股 % × 估值 = 团队净值）这一周内增长了一次。Sequoia 这一周拿到的 Anthropic 股份按比例对应的 60 亿美金估值，去年只值 4 亿。一句话总结：**通谕骂集中的那一周，是 AI 集中度自历史新高的那一周**。
...
教皇那一边骂「AI 不能用于战争」，台上还坐着 Olah。Anthropic 是这一群公司里**唯一一家在合同条款上写明拒绝让自己的模型被用于自主武器的公司**——OpenAI 在 2024 年 1 月已经悄悄从政策里删掉了「不得用于军事和战争」的禁令；Google 2018 年 Project Maven 抗议之后短暂退出 DOD，2024 年初已经全面回归；xAI 从来没有过这种约束。

通谕第三章那一句「AI 必须被解除武装」如果按字面执行，整个西方 AI 产业现状里**唯一勉强能算「已解除武装」的是 Anthropic 一家**。这家公司这一周一边在台上拿圣油，另一边在加州联邦法院和五角大楼打官司证明自己「应该」被允许做生意——而它打这场官司打的恰恰是它「已解除武装」这件事造成的市场惩罚。

通谕的伦理立场和 Anthropic 的商业立场在这一段是一致的。但这种一致**让 Anthropic 这一周的商业利益和教皇的宗教立场互相加分**：教皇得到一个看起来在道德上靠得住的 AI 公司站台，Anthropic 得到一个在 Pentagon 把它排除掉的同一个月里来自梵蒂冈的世界级背书。

5 月 1 日 DOD 8 家名单出来那天，Anthropic 股权市场反应是估值预期下调（5 月 2 日多家投资银行下调 Anthropic 估值模型 5-10%）。5 月 25 日 Olah 出现在教皇身边那天，Anthropic 估值已经从 5 月 12 日 Bloomberg 首次披露的 9000 亿压在融资文件里——这一轮估值是教皇站台**之前**就敲定的，但教皇站台的视频会在 Sequoia 和 Dragoneer 等 LP 募资材料里用十年。
...
梵蒂冈的发布会**同时解决了这四件事**：估值故事里写「连教皇都站台」、国防市场之外开辟「全球宗教民间认同」赛道、把「算力地主马斯克」的角色公关化（"我们被绑架了，所以更需要外部监督"）、把创始团队的安全派身份资产化（"我们一直说的就是这些"）。
...
- [Vatican News — Pope Leo XIV's first encyclical "Magnifica humanitas" to be published May 25 (5/18)](https://www.vaticannews.va/en/pope/news/2026-05/pope-leo-xiv-first-encyclical-magnifica-humanitas.html)
- [Vatican News — Pope Leo presents 'Magnifica humanitas' calling for disarmament of AI (5/25)](https://www.vaticannews.va/en/pope/news/2026-05/pope-leo-xiv-magnifica-humanitas-presentation-ai-disarmament.html)
- [Anthropic — Chris Olah's remarks on Pope Leo XIV's encyclical "Magnifica humanitas" (5/25)](https://www.anthropic.com/news/chris-olah-pope-leo-encyclical)
- [CNN — Pope Leo warns of AI fueling warfare in first major theological document (5/25)](https://www.cnn.com/2026/05/25/europe/pope-leo-ai-encyclical-magnifica-humanitas-intl)
- [Fortune — Pope Leo called AI an 'instrument of domination, exclusion and death.' Anthropic was in the room (5/25)](https://fortune.com/2026/05/25/pope-leo-xiv-ai-domination-death-anthropic-olah-encyclical/)
- [Religion News Service — In his first encyclical, Pope Leo XIV says AI must serve humanity, not the powerful few (5/25)](https://religionnews.com/2026/05/25/in-his-first-encyclical-pope-leo-xiv-says-ai-must-serve-humanity-not-the-powerful-few/)
- [Al Jazeera — Pope says AI must be 'disarmed' to prevent domination, exclusion, and death (5/25)](https://www.aljazeera.com/news/2026/5/25/pope-says-ai-must-be-disarmed-to-prevent-domination-exclusion-and-death)
- [NPR — Pope Leo takes aim at big tech in sweeping encyclical on AI (5/25)](https://www.npr.org/2026/05/25/nx-s1-5828375/pope-leo-to-weigh-in-on-the-perils-and-promises-of-artificial-intelligence)
- [Time — Pope Leo Uses First Major Papal Text to Warn About Dangers of AI (5/25)](https://time.com/article/2026/05/25/pope-leo-encyclical-ai-magnifica-humanitas/)
- [National Catholic Reporter — Pope Leo to present his encyclical on AI alongside Anthropic co-founder (5/18)](https://www.ncronline.org/vatican/vatican-news/pope-leo-present-his-encyclical-ai-alongside-anthropic-co-founder)
- [National Catholic Reporter — Why is AI company Anthropic helping launch Pope Leo XIV's encyclical?](https://www.ncronline.org/news/why-ai-company-anthropic-helping-launch-pope-leo-xivs-encyclical)
...
- [Bloomberg — Pentagon Tests OpenAI, Google AI Models as It Seeks Anthropic Alternatives (5/21)](https://www.bloomberg.com/news/articles/2026-05-21/pentagon-tests-rival-ai-models-in-race-to-replace-anthropic)
- [CNBC — Anthropic set to hit $10.9 billion in revenue in Q2, source says (5/20)](https://www.cnbc.com/2026/05/20/anthropic-revenue-explosive-growth-ipo-profitable-quarter.html)
- [TechCrunch — Anthropic will pay xAI $1.25 billion per month for compute (5/20)](https://techcrunch.com/2026/05/20/anthropic-will-pay-xai-1-25-billion-per-month-for-compute/)
- [Axios — Anthropic is paying SpaceX $15 billion per year (5/20)](https://www.axios.com/2026/05/20/anthropic-spacex-compute)
- [SEC EDGAR — SpaceX S-1 Filing (5/20)](https://www.sec.gov/cgi-bin/browse-edgar)
- [CNN Business — Judge blocks Pentagon's effort to 'punish' Anthropic by labeling it a supply chain risk (3/26)](https://www.cnn.com/2026/03/26/business/anthropic-pentagon-injunction-supply-chain-risk)
- [Bloomberg — Pentagon Notifies Anthropic It's Deemed Firm a Supply-Chain Risk (3/5)](https://www.bloomberg.com/news/articles/2026-03-05/pentagon-says-it-s-told-anthropic-the-firm-is-supply-chain-risk)
- [Breaking Defense — Pentagon clears 8 tech firms to deploy their AI on its classified networks (5/1)](https://breakingdefense.com/2026/05/pentagon-clears-7-tech-firms-to-deploy-their-ai-on-its-classified-networks/)
- [Where's Your Ed At — Anthropic's "Profitability" Swindle (5/22)](https://www.wheresyoured.at/anthropics-profitability-swindle/)
- [Washington Post — Pope elevates AI ethics to a religious imperative with first encyclical (5/25)](https://www.washingtonpost.com/world/2026/05/25/pope-elevates-ai-ethics-religious-imperative-with-first-encyclical/)
- [The Next Web — From the Vatican stage, Anthropic's Chris Olah says AI cannot be steered by AI labs alone (5/25)](https://thenextweb.com/news/anthropic-olah-vatican-ai-oversight-big-tech)
