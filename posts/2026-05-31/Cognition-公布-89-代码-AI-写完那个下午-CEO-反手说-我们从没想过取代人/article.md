...
<div class="img-placeholder concept">
  ...
  <details><summary>生成 Prompt</summary><pre>A modern minimalist illustration showing two stacked documents - the top one labeled with a large 89% in blue, the bottom showing a podium microphone with a speech bubble, juxtaposed against a calendar showing two days, flat design, minimalist illustration, tech style, blue and white color palette, no text, no labels, clean white background</pre></details>
</div>
...
【副标题】：5 月 27 - 29 日 Cognition 的两个数字版本
【核心判断】：同一张嘴，48 小时，喂两个不同市场
【核心内容】：
  - 5/27 公关稿「Devin 写 89% 代码」[流入]：89
  - 5/29 现场「我们从没想过取代人」[流出]：100
  - 12/2025 基线（5 个月前 Devin 占比） [参照]：13</pre></details>
</div>
...
<div class="img-placeholder concept">
  <div class="img-placeholder-icon">🎨</div>
  <div class="img-placeholder-label">概念图占位</div>
  <details><summary>生成 Prompt</summary><pre>A flat design illustration showing four glass tubes labeled with company silhouettes (a luxury car, a bank, a stock exchange, and a startup office), all being filled by streams of blue code symbols flowing from above, with empty chairs at desks below each tube, flat design, minimalist illustration, tech style, blue and white color palette, no text, no labels, clean white background</pre></details>
</div>
...
【副标题】：6 家公司市销率（P/S）对比 - Cognition 的 53 倍贵在哪里
【单位】：倍
【核心判断】：53 倍 P/S 卖的不是 ARR，是「Devin 替换 junior engineer」这张赌票
【核心内容】：
  - Cognition [流出]：53
  - Anthropic [参照]：32
  - Cursor [参照]：25
